...
using Lemoncode.Azure.Api.Controllers;
...
builder.Services.AddDbContext<ApiDBContext>(options =>
    ...
    //options.UseSqlServer(builder.Configuration.GetConnectionString("ApiDBContextLocal") ?? throw new InvalidOperationException("Connection string 'ApiDBContext' not found.")));
